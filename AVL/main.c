...
Node *remover(Node *raiz, int valor){
    Node *noExcluir = SearchNode(valor, raiz);
    Node *noPaiExlcui = SearchDad(valor, raiz);
    printf("Valor a ser exlcuido = %d\n",noExcluir->value);
    printf("Pai do valor a ser = %d\n",noExcluir->value);
